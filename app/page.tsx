...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.16),_transparent_30%),radial-gradient(circle_at_top_right,_rgba(6,182,212,0.16),_transparent_28%),linear-gradient(135deg,_rgba(248,250,252,0.98),_rgba(240,253,250,0.95))] text-slate-900 transition-colors dark:bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.2),_transparent_25%),radial-gradient(circle_at_top_right,_rgba(6,182,212,0.2),_transparent_28%),linear-gradient(135deg,_rgba(2,6,23,0.98),_rgba(15,23,42,0.95))] dark:text-slate-100">
        ...
        <section id="hero" className="mx-auto grid max-w-7xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8 lg:py-24">
          <ScrollReveal className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200/80 bg-emerald-50/80 px-3 py-2 text-sm font-medium text-emerald-700 shadow-sm backdrop-blur dark:border-emerald-800/70 dark:bg-emerald-950/40 dark:text-emerald-300">
              <Sparkles size={16} />
              Premium nutrition science portfolio
            </div>
            ...
            <GlassPanel className="space-y-6">
              ...
              <div className="space-y-3 rounded-2xl border border-emerald-100 bg-emerald-50/70 p-4 dark:border-emerald-900/40 dark:bg-emerald-950/30">
                ...
                <p className="text-lg font-medium text-slate-800 dark:text-white">
                  Translating nutrition science into compassionate, evidence-backed patient care.
                </p>
              </div>
            </GlassPanel>
          </ScrollReveal>
        ...
        <section id="research" className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-16">
          <ScrollReveal>
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <GlassPanel className="grid gap-3 sm:grid-cols-2">
        ...
        <section id="contact" className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-16">
          <ScrollReveal>
            <GlassPanel className="space-y-6 rounded-[2rem] border-cyan-200/70 bg-gradient-to-br from-cyan-50 to-white p-8 dark:border-cyan-800/50 dark:from-cyan-950/40 dark:to-slate-900/70">
              <SectionHeading
                eyebrow="Contact"
                title="Let’s build healthier futures through nutrition"
                description="I would welcome the opportunity to connect with clinics, teams, and organizations focused on patient wellness."
              />
